...
| `feedback.warningHue = 85°`, candidates `[70°, 85°, 100°]`, chroma `0.14`                         | Warning amber 후보 inventory                | semantic amber를 위한 `product-policy`; ±15° ladder와 정확한 chroma는 임의성이 남은 bounded recipe                                                                                                                                                                                                                                                                 |
| `feedback.warningLightness.light = 0.65`, `dark = 0.72`, ranges `[0.52, 0.72]` / `[0.62, 0.80]`   | Warning mode anchor와 inventory             | mode와 label을 만족시키기 위한 `product-policy`/`heuristic`; 외부 표준 없음                                                                                                                                                                                                                                                                                        |
